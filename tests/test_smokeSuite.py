...
class TestSmokeSuite():
  ...
  def test_logoHomePage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(808, 720)
  ...
  def test_navigateJoinPage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Llumiquinga")
    self.driver.find_element(By.NAME, "bizname").send_keys("Maribao")
